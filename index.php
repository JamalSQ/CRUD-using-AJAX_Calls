...
<body>
    <div class="container m-5">
        <div class="row">
            <h1 class="text-center m-4 title">CRUD Using AJAX</h1>
            <div class="col-md-6">
                <form id="productForm">
...
function updateData(){
    ...
    .slideUp();
            ...
            $.ajax({
                url: 'updateProduct.php', // Ensure this path is correct
                method: 'POST',
                data: {
                    id:id,
                    pname: pname,
...
function fetchdataOnID(id){
  ...
  $.ajax({
        ...
        success:function(data){
          $("#upid").val(id);
          $("#upname").val(data.pname);
          $("#upprice").val(data.pprice);
        }
  });
}
...
// Inserting data 
    ...
    .slideUp();
            ...
            $.ajax({
                url: 'insertdata.php', // Ensure this path is correct
                method: 'POST',
                data: {
                    pname: pname,
                    pprice: pprice
